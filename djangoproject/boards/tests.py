...
from .forms import NewTopicForms
...
class BoardTopicsTests(TestCase):
    def setUp(self):
        Board.objects.create(name='Django',description='Django project')
    ...
    def test_board_topics_failed_status_code(self):
    ...
    def test_board_view_nav_bar(self):
        board_topics_url=reverse('board_topics',kwargs={'pk':1})
        homepage_url=reverse('home')
...
class NewTopcicsTests(TestCase):
    def setUp(self):
        ...
        User.objects.create_user(username='John',email='johndoe@gmail.com',password='abc')
    ...
    def test_new_topic_view_failure_code(self):
    ...
    def test_new_topic_view_contains_link_back(self):
        new_topic_url=reverse('new_topic',kwargs={'pk':1 })
    ...
    def test_new_topic_value_input(self):
        url=reverse('new_topic',kwargs={'pk':1})
        data={
            'subject': 'Testing',
            'message':'This is the board for Testing'
        }
    ...
    def test_new_topic_invalid_input(self):
    ...
    def test_new_topic_invalid_input_empty_field(self):
        url=reverse('new_topic',kwargs={'pk':1})
        data={
            'subject': '',
            'message':''
    ...
    def test_contains_form(self):
        ...
        response=self.client.get(url)
        form=response.context.get('form')
        self.assertIsInstance(form,NewTopicForms)
